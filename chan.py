...
if restaurants:
    ...
    st.markdown("<div class='restaurant-container' style='display: flex; flex-wrap: wrap; gap: 40px; justify-content: flex-start; width: 100%; margin: 0 auto;'>", unsafe_allow_html=True)
    for restaurant in restaurants:
        ...
        st.markdown(f"""
<div class="card" style="flex: 1 1 calc(30% - 40px); margin-bottom: 20px; padding: 20px; border-radius: 10px; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1);">
