...
if restaurants:
    ...
    st.markdown("<div class='restaurant-container' style='display: flex; flex-wrap: wrap; gap: 20px; justify-content: space-around; width: 100%; margin: 0 auto;'>", unsafe_allow_html=True)
