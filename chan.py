...
if restaurants:
    ...
    st.markdown("<div class='restaurant-container' style='display: flex; flex-wrap: wrap; gap: 40px; justify-content: center; width: 90%; margin: 0 auto;'>", unsafe_allow_html=True)
